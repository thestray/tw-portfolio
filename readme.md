# Technical Writing Portfolio Samples (Out of date)

This repository contains several of my writing samples.

The first **MasterTOEICListening.md** is an example of an article I wrote as part of a series for an Education Startup.  
